...
public class SaveAsPNGDemo1 {
  public static void main(String [] args) {
	  if (args.length <= 0) {
		  System.out.println("Usage: " + SaveAsPNGDemo1.class.getName() + " licenseKey");
		  System.exit(1);
	  }
    ...
    try {
      for (int i=0; allPages != null && i < allPages.length; i++) {
        String fileName = "smartjprint_pngdemo1_page_" + (i+1) + ".png";
        AtImageFactory.saveAsPNG(allPages[i], fileName);
