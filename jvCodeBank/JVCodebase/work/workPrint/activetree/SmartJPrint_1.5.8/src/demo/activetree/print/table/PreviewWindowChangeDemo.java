/**
 * Source: PreviewWindowChangeDemo.java
 * Version: ${VERSION}$
...
public class PreviewWindowChangeDemo extends PrintFrame {
	private JTable table = null;

	public PreviewWindowChangeDemo() {
		super();
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getActionCommand().equals("Print")) {
			...
			//change the preview properties.
			AtPreviewFrame previewWindow = tablePrinter.getPreviewWindow();
			previewWindow.setPreviewButtonVisible(AtPreviewFrame.THUMBNAILS_BUTTON, false);
			previewWindow.setThumbnailsVisible(false);
		}
	}
	...
	public static void main(String[] args) {
		if (args != null && args.length >= 1) {
			...
			System.out.println("Usage: java " + PreviewWindowChangeDemo.class.getName() + " licenseKey");
			System.exit(0);
		}
		PrintFrame demo = new PreviewWindowChangeDemo();
		demo.postInit();
