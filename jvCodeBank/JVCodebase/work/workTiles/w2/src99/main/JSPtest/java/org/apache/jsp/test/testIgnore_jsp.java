...
public final class testIgnore_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_tiles_insert_ignore_beanName;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_tiles_insert_ignore_beanName = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  }
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_tiles_insert_ignore_beanName.release();
  }
  ...
  private boolean _jspx_meth_tiles_insert_0(PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_insert_0.setTemplate("layoutTestIgnore.jsp");
  ...
  private boolean _jspx_meth_tiles_put_0(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_0.setValue("Test ignore : body isn't defined");
  ...
  private boolean _jspx_meth_tiles_insert_1(PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_insert_1.setTemplate("layoutTestIgnore.jsp");
  ...
  private boolean _jspx_meth_tiles_put_2(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_1, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_2.setValue("Test ignore : bad body definition name (exception must be shown)");
  ...
  private boolean _jspx_meth_tiles_put_4(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_1, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_4.setValue("badDefinitionName");
    _jspx_th_tiles_put_4.setType("definition");
  ...
  private boolean _jspx_meth_tiles_put_5(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_definition_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_5.setName("title");
    _jspx_th_tiles_put_5.setValue("Test ignore : Definition not found (no errors, no insertion)");
  ...
  private boolean _jspx_meth_tiles_put_6(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_definition_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_6.setValue("header.jsp");
  ...
  private boolean _jspx_meth_tiles_put_7(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_definition_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_7.setName("body");
    _jspx_th_tiles_put_7.setValue("body.jsp");
  ...
  private boolean _jspx_meth_tiles_insert_2(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:insert
    org.apache.struts.taglib.tiles.InsertTag _jspx_th_tiles_insert_2 = (org.apache.struts.taglib.tiles.InsertTag) _jspx_tagPool_tiles_insert_ignore_beanName.get(org.apache.struts.taglib.tiles.InsertTag.class);
    _jspx_th_tiles_insert_2.setPageContext(_jspx_page_context);
    _jspx_th_tiles_insert_2.setParent(null);
    _jspx_th_tiles_insert_2.setBeanName("badTemplateDefinitionName");
    _jspx_th_tiles_insert_2.setIgnore(true);
    ...
    if (_jspx_th_tiles_insert_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_tiles_insert_ignore_beanName.reuse(_jspx_th_tiles_insert_2);
    return false;
  }
  ...
  private boolean _jspx_meth_tiles_insert_3(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:insert
    org.apache.struts.taglib.tiles.InsertTag _jspx_th_tiles_insert_3 = (org.apache.struts.taglib.tiles.InsertTag) _jspx_tagPool_tiles_insert_template.get(org.apache.struts.taglib.tiles.InsertTag.class);
    _jspx_th_tiles_insert_3.setPageContext(_jspx_page_context);
    _jspx_th_tiles_insert_3.setParent(null);
    _jspx_th_tiles_insert_3.setTemplate("layoutTestIgnore.jsp");
    ...
    if (_jspx_eval_tiles_insert_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n  ");
        if (_jspx_meth_tiles_put_8(_jspx_th_tiles_insert_3, _jspx_page_context))
          return true;
        out.write("\r\n  ");
        if (_jspx_meth_tiles_put_9(_jspx_th_tiles_insert_3, _jspx_page_context))
          return true;
        out.write("\r\n  ");
        if (_jspx_meth_tiles_put_10(_jspx_th_tiles_insert_3, _jspx_page_context))
          return true;
        out.write('\r');
        out.write('\n');
    ...
    if (_jspx_th_tiles_insert_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_tiles_insert_template.reuse(_jspx_th_tiles_insert_3);
    return false;
  }

  private boolean _jspx_meth_tiles_put_8(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_3, PageContext _jspx_page_context)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:put
    ...
    _jspx_th_tiles_put_8.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_tiles_insert_3);
    _jspx_th_tiles_put_8.setName("title");
    _jspx_th_tiles_put_8.setValue("Test ignore : bad body urls (exception must be shown)");
  ...
  private boolean _jspx_meth_tiles_put_9(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_3, PageContext _jspx_page_context)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:put
    ...
    _jspx_th_tiles_put_9.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_tiles_insert_3);
    _jspx_th_tiles_put_9.setName("header");
    _jspx_th_tiles_put_9.setValue("header.jsp");
  ...
  private boolean _jspx_meth_tiles_put_10(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_3, PageContext _jspx_page_context)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:put
    ...
    _jspx_th_tiles_put_10.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_tiles_insert_3);
    _jspx_th_tiles_put_10.setName("body");
    _jspx_th_tiles_put_10.setValue("body2.jsp");
