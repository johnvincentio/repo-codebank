...
public final class basicFramesetPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_tiles_insert_0(PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_insert_0.setTemplate("/tutorial/basic/myFramesetLayout.jsp");
  ...
  private boolean _jspx_meth_tiles_put_0(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_0.setContent("My first frameset page");
  ...
  private boolean _jspx_meth_tiles_put_1(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_1.setContent("/tutorial/common/header.jsp");
  ...
  private boolean _jspx_meth_tiles_put_2(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:put
    org.apache.struts.taglib.tiles.PutTag _jspx_th_tiles_put_2 = (org.apache.struts.taglib.tiles.PutTag) _jspx_tagPool_tiles_put_name_direct_content.get(org.apache.struts.taglib.tiles.PutTag.class);
    ...
    _jspx_th_tiles_put_2.setContent("/tutorial/common/footer.jsp");
    _jspx_th_tiles_put_2.setDirect("true");
    ...
    if (_jspx_th_tiles_put_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_tiles_put_name_direct_content.reuse(_jspx_th_tiles_put_2);
    return false;
  }
  ...
  private boolean _jspx_meth_tiles_put_3(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_0, PageContext _jspx_page_context)
    ...
    _jspx_th_tiles_put_3.setContent("/tutorial/basic/menu.jsp");
  ...
  private boolean _jspx_meth_tiles_put_4(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_insert_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  tiles:put
    org.apache.struts.taglib.tiles.PutTag _jspx_th_tiles_put_4 = (org.apache.struts.taglib.tiles.PutTag) _jspx_tagPool_tiles_put_name_direct_content.get(org.apache.struts.taglib.tiles.PutTag.class);
    ...
    _jspx_th_tiles_put_4.setContent("/tutorial/basic/helloBody.jsp");
    _jspx_th_tiles_put_4.setDirect("true");
    ...
    if (_jspx_th_tiles_put_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_tiles_put_name_direct_content.reuse(_jspx_th_tiles_put_4);
    return false;
  }
}
