...
public class Count {
	...
	private static final String[] m_astrTypes = {"other", 
					"class", "jar", "pdf", 
					"java", 
					"jsp", "js", "xml", "xsl", "xsd", "xmi", 
					"html", "css", 
					"properties", "mf",
...
//		System.out.println("strExt :"+strExt+":");
	...
	private void doReport (String strDir) {
		...
		for (int i=0; i < m_nTypes; i++) {		
			System.out.println("(" + m_astrTypes[i] + ", " +
					m_nFiles[i] + ", " + m_nLines[i] + ")");
		}
	}
}
