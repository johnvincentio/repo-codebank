...
@echo on
  %JBIN%\java -classpath %XALAN_JARS% org.apache.xalan.xslt.Process -IN %1 -XSL %2 -OUT %3   -PARAM sortLinks "yes" -PARAM chapNum "10" -PARAM chapTitle "Displaying XML with CSS"
@echo off
