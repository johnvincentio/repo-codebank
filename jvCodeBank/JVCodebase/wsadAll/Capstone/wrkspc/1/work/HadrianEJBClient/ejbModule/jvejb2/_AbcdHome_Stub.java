...
public class _AbcdHome_Stub extends Stub implements AbcdHome {
    
    private static final String[] _type_ids = {
        "RMI:jvejb2.AbcdHome:0000000000000000", 
    ...
    public Abcd create() throws RemoteException, CreateException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Abcd) in.read_Object(Abcd.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",jvejb2.AbcdHome.class);
            if (so == null) {
                return create();
            }
            try {
                Abcd result = ((jvejb2.AbcdHome)so.servant).create();
                return (Abcd)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
