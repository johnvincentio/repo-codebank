...
public class EJSRemoteStatelessAbcd_d7cd89da extends EJSWrapper implements Abcd {
	 ...
	 * addAlert
	 */
	public void addAlert(int nEventid, int nRoleid, int nAlertlevel, int nAlertnumber, java.lang.String strMsg) throws java.rmi.RemoteException {
		EJSDeployedSupport _EJS_s = getDeployedSupport();
		Object[] _jacc_parms = null;
		...
		try {
			if (container.doesJaccNeedsEJBArguments( this ))
			{
				...
				_jacc_parms[0] = new java.lang.Integer(nEventid);
				_jacc_parms[1] = new java.lang.Integer(nRoleid);
				_jacc_parms[2] = new java.lang.Integer(nAlertlevel);
				_jacc_parms[3] = new java.lang.Integer(nAlertnumber);
				_jacc_parms[4] = strMsg;
			}
	jvejb2.AbcdBean beanRef = (jvejb2.AbcdBean)container.preInvoke(this, 7, _EJS_s, _jacc_parms);
			beanRef.addAlert(nEventid, nRoleid, nAlertlevel, nAlertnumber, strMsg);
		}
		catch (java.rmi.RemoteException ex) {
			_EJS_s.setUncheckedException(ex);
		}
