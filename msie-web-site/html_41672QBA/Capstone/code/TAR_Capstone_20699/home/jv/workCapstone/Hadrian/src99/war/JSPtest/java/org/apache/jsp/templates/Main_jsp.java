...
public final class Main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	attribs.showParams ("Main");
      ...
      if (_jspx_eval_html_html_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n<head>\n\t<title>");
          out.print(jvTemplates.getTitle());
          out.write("</title>\n\t");
 ...
 Debug.println("Main.jsp; stage 1"); 
          out.write("\n\t\t\t");
          org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, jvTemplates.getHeader().getFile(), out, false);
          out.write("\n\t\t\t");
 Debug.println("Main.jsp; stage 2"); 
          out.write("\n\t\t</td>\n\t</tr>\n\t<tr>\n\t\t<td width=\"140\" valign=\"top\">\n\t\t\t");
 Debug.println("Main.jsp; stage 3"); 
          out.write("\n\t\t\t");
          org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, jvTemplates.getMenu().getFile(), out, false);
          out.write("\n\t\t\t");
 Debug.println("Main.jsp; stage 4"); 
          out.write("\n\t\t</td>\n\t\t<td valign=\"top\"  align=\"left\">\n\t\t\t");
 Debug.println("Main.jsp; stage 5"); 
          out.write("\n\t\t\t");
          org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, jvTemplates.getBody().getFile(), out, false);
          out.write("\n\t\t\t");
 Debug.println("Main.jsp; stage 6"); 
          out.write("\n\t\t</td>\n\t</tr>\n\t<tr>\n\t\t<td colspan=\"2\">\n\t\t\t<hr>\n\t\t</td>\n\t</tr>\n\t<tr>\n\t\t<td colspan=\"2\">\n\t\t\t");
 Debug.println("Main.jsp; stage 7"); 
          out.write("\n\t\t\t");
          org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, jvTemplates.getFooter().getFile(), out, false);
          out.write("\n\t\t\t");
