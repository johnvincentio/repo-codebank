...
5.  <logic:iterate id="item" type="jvcommon.JVCatalogName"
			name="CatalogNames" property="items">
	Iterate over the bean called CatalogNames, each item is given a name "item"
	and is of class "jvcommon.JVCatalogName". Each item is retrieved using 
...
<logic:iterate id="item" type="jvcommon.JVCatalogName"
			name="CatalogNames" property="items">
