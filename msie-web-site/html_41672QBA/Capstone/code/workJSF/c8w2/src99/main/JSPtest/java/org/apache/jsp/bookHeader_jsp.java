...
public final class bookHeader_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
      out.write('\n');
      if (_jspx_meth_h_panelGrid_0(_jspx_page_context))
        return;
      out.write('\n');
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_h_panelGrid_0(PageContext _jspx_page_context)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  h:panelGrid
    com.sun.faces.taglib.html_basic.PanelGridTag _jspx_th_h_panelGrid_0 = (com.sun.faces.taglib.html_basic.PanelGridTag) _jspx_tagPool_h_panelGrid_styleClass_columns.get(com.sun.faces.taglib.html_basic.PanelGridTag.class);
    _jspx_th_h_panelGrid_0.setPageContext(_jspx_page_context);
    _jspx_th_h_panelGrid_0.setParent(null);
    _jspx_th_h_panelGrid_0.setColumns("1");
    _jspx_th_h_panelGrid_0.setStyleClass("bookHeader");
    ...
    if (_jspx_eval_h_panelGrid_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      if (_jspx_meth_h_outputText_0(_jspx_th_h_panelGrid_0, _jspx_page_context))
        return true;
      out.write("\n   ");
      if (_jspx_meth_f_verbatim_0(_jspx_th_h_panelGrid_0, _jspx_page_context))
        return true;
      out.write('\n');
    }
  ...
  private boolean _jspx_meth_h_outputText_0(javax.servlet.jsp.tagext.JspTag _jspx_th_h_panelGrid_0, PageContext _jspx_page_context)
    ...
    _jspx_th_h_outputText_0.setValue("#{msgs[book.titleKey]}");
    _jspx_th_h_outputText_0.setStyleClass("bookTitle");
  ...
  private boolean _jspx_meth_f_verbatim_0(javax.servlet.jsp.tagext.JspTag _jspx_th_h_panelGrid_0, PageContext _jspx_page_context)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  f:verbatim
    ...
    _jspx_th_f_verbatim_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_h_panelGrid_0);
